...
#get the number of crime in each bar as variable "crimesum"
...
quan=rank/nrow(crimesum)
quan=data.frame(cbind(Bar=crimesum[,1],quan))
quan[,1]=as.character.factor(quan[,1])
